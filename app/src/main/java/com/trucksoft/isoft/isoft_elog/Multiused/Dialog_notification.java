...
public class Dialog_notification {
...
//     static Fragment activity=null;
    ...
    static FragmentActivity activityfra;
    private  static String   upLoadServerUri = "http://eld.e-logbook.info/elog_app/upload_to_server.php";
    public static void setpopupnotification(final FragmentActivity activity, final Context context, String msgg, final String status, final String breakid)
    {
        if(activity !=null) {
...
//        String msg=pref.getString(Constant.NOTIFY_MESSAGE);
    ...
    private static void requestPermission(FragmentActivity activity) {
    ...
    private static void callrecorddialog(final FragmentActivity activity,final Context context)
    {
        final Timer T;
...
//                }
                ...
                dialogz = ProgressDialog.show(context, "Uploading",
                        "Please wait...", true);
                new ImageUploadTask().execute();
            }
        });
