...
public class Notiication_home extends AppCompatActivity {
    Notif_receyadap adapter;
...
}catch (Exception e)
{
        ...
        adapter = new Notif_receyadap(contexts, movies);


        adapter.setLoadMoreListener(new Notif_receyadap.OnLoadMoreListener() {
            @Override
...
//                        "&feature=Notification");
        ...
        Call<List<Notiflist_model>> call = api.getNotificationlist(pref.getString(Constant.DRIVER_ID),""+strfromdate,""+strtodate,""+page,pref.getString(Constant.COMPANY_CODE),pref.getString(Constant.VIN_NUMBER),""+lat,""+lon,""+straddress,""+strstate,"Notification");

        call.enqueue(new Callback<List<Notiflist_model>>() {
            @Override
            public void onResponse(Call<List<Notiflist_model>> call, Response<List<Notiflist_model>> response) {
            ...
            @Override
            public void onFailure(Call<List<Notiflist_model>> call, Throwable t) {
...
//Log.e("indexc","loadmpre"+index);
        ...
        movies.add(new Notiflist_model("load"));
        ...
        Call<List<Notiflist_model>> call = api.getNotificationlist(pref.getString(Constant.DRIVER_ID),""+strfromdate,""+strtodate,""+ab,pref.getString(Constant.COMPANY_CODE),pref.getString(Constant.VIN_NUMBER),""+lat,""+lon,""+straddress,""+strstate,"Notification");
        ...
        call.enqueue(new Callback<List<Notiflist_model>>() {
            ...
            public void onResponse(Call<List<Notiflist_model>> call, Response<List<Notiflist_model>> response) {
                ...
                if(response.isSuccessful()){
                    ...
                    List<Notiflist_model> result = response.body();
