...
public class Speedometer extends View implements SpeedChangeListener {
	...
	public static final float DEFAULT_MAX_SPEED = 240; // Assuming this is km/h and you drive a super-car
	...
	private void initDrawingTools(){
		...
		readingPaint.setTextSize(35f);//kilomet text
