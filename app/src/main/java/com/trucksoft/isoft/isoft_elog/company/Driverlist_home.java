...
public class Driverlist_home extends FragmentActivity implements View.OnClickListener {
    driver_receyadap adapter;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.driverlist_home);
        contexts=this;
...
txtybe=findViewById(R.id.dds);
        ...
        adapter = new driver_receyadap(contexts, movies);


        adapter.setLoadMoreListener(new driver_receyadap.OnLoadMoreListener() {
            @Override
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.driver_list_iv_back:
                Intent mIntentz = new Intent(
                        Driverlist_home.this,
                        companydashboard.class);
                startActivity(mIntentz);
...
deleteCache(contexts);
                Intent mIntent = new Intent(Driverlist_home.this,
                        adddriver.class);
...
//Log.e("kd",""+datess);
        ...
        Call<root_model> call = api.getdriverlist(page,pref.getString(Constant.COMPANY_LOGIN_CODE));

        call.enqueue(new Callback<root_model>() {
            @Override
            public void onResponse(Call<root_model> call, Response<root_model> response) {
                ...
                if(response.isSuccessful()){
                    ...
                    if(response.body() !=null) {
                        root_model result = response.body();
                      if(result.status) {
                          pref.putString(Constant.LAST_INDEX,""+result.driverData.size());
                          movies.addAll(result.driverData);
                      }
                    }else{
            ...
            @Override
            public void onFailure(Call<root_model> call, Throwable t) {
...
//Log.e("call","loadmpre");
        ...
        movies.add(new driver_model("load"));
