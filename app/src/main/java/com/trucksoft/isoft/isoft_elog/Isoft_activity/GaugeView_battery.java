...
public class GaugeView_battery extends View {
	...
	public static final float SCALE_END_VALUE = 32.0f;
	public static final float SCALE_START_ANGLE = 100.0f;// this line inner
	//public static final int SCALE_DIVISIONS = 10;
	public static final int SCALE_DIVISIONS = 4;
	//public static final int SCALE_SUBDIVISIONS = 5;
	public static final int SCALE_SUBDIVISIONS = 7;
...
public static final int[] RANGE_COLORS = {Color.rgb(255, 255, 255), Color.rgb(255, 255, 255),
	...
	public GaugeView_battery(final Context context, final AttributeSet attrs, final int defStyle) {
		super(context, attrs, defStyle);
		readAttrs(context, attrs, defStyle);
		init();
	}

	public GaugeView_battery(final Context context, final AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public GaugeView_battery(final Context context) {
		this(context, null, 0);
	}
    ...
    private void readRanges(final CharSequence[] rangeValues, final CharSequence[] rangeColors) {
        ...
        if (rangeValues == null) {
			...
			Log.e("rangeValuesLength1","@"+rangeValuesLength);
        } else {
            rangeValuesLength = rangeValues.length;
			Log.e("rangeValuesLength0",""+rangeValuesLength);
        }
        ...
        if (rangeValues != null) {
            ...
            for (int i = 0; i < length; i++) {
				Log.e("mRangeValues",""+ Float.parseFloat(rangeValues[i].toString()));
...
//		mNeedleRightPath.lineTo(x + mNeedleWidth, y);
		...
		float khk= Float.parseFloat("0.015");
		mNeedleLeftPath.moveTo(x, y);
		mNeedleLeftPath.lineTo(x - khk, y);
		mNeedleLeftPath.lineTo(x, y - mNeedleHeight);
		mNeedleLeftPath.lineTo(x, y);
		mNeedleLeftPath.lineTo(x - khk, y);
		...
		mNeedleRightPath = new Path();
		mNeedleRightPath.moveTo(x, y);
		Log.e("mNeedleWidth",""+mNeedleWidth);
		Log.e("mNeedleHeight",""+mNeedleHeight);
		//mNeedleRightPath.lineTo(x + mNeedleWidth, y);
		float kh= Float.parseFloat("0.015");
		mNeedleRightPath.lineTo(x+kh  , y);
